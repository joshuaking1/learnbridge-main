...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Forwarding assessment generation request to AI service:', {
      url: `${AI_SERVICE_URL}/api/ai/generate/assessment`,
    ...
    const response = await fetch(`${AI_SERVICE_URL}/api/ai/generate/assessment`, {
      method: 'POST',
      headers: {
    ...
    console.error('Error in AI assessment generation API route:', error);
    return NextResponse.json(
