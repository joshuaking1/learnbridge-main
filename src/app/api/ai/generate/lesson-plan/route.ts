...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Forwarding lesson plan generation request to AI service:', {
      url: `${AI_SERVICE_URL}/api/ai/generate/lesson-plan`,
    ...
    const response = await fetch(`${AI_SERVICE_URL}/api/ai/generate/lesson-plan`, {
      method: 'POST',
      headers: {
    ...
    console.error('Error in AI lesson plan generation API route:', error);
    return NextResponse.json(
