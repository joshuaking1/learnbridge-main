...
export default function MyTosPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-100 p-4 md:p-8">
            ...
            {/* Loading State */}
            {isLoadingTos && (<div className="flex justify-center items-center py-12"><Loader2 className="h-8 w-8 animate-spin text-brand-darkblue" /></div>)}
            {/* Error State */}
            {!isLoadingTos && errorLoading && (<Alert variant="destructive" className="mb-6"><AlertTitle>Error</AlertTitle><AlertDescription>{errorLoading}</AlertDescription></Alert>)}
            {/* No ToS State */}
