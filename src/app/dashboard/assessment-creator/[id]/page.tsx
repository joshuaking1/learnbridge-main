...
export default function ViewAssessmentPage() {
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            const response = await fetch(`https://learnbridge-teacher-tools-service.onrender.com/api/teacher-tools/assessments/${assessmentId}` , { // https://learnbridge-teacher-tools-service.onrender.com/api/teacher-tools/assessments/${assessmentId}
                method: 'PUT',
